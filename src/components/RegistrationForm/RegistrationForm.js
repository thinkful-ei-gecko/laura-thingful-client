...
export default class RegistrationForm extends Component {
  ...
  render() {
    ...
    return (
      <form className='RegistrationForm RegLogForm' onSubmit={this.handleSubmit} >
        <div role='alert'>
        ...
        <div className='full_name'>
          ...
          <Input name='full_name' type='text' required className='formBox'
        ...
        <div className='user_name'>
          ...
          <Input name='user_name' type='text' required className='formBox'
        ...
        <div className='password'>
          ...
          <Input name='password' type='password' required className='formBox'
        ...
        <div className='nick_name'>
          ...
          <Input name='nick_name' type='text' required className='formBox'
